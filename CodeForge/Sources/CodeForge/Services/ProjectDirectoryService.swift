...
/// Manages project working directories under ~/CodeForge/projects/
actor ProjectDirectoryService {
    ...
    init(baseDirectory: String? = nil) {
        if let base = baseDirectory {
            ...
            self.baseDirectory = "\(home)/CodeForge/projects"
        }
    }
    ...
    func createProjectDirectory(name: String) async throws -> String {
        ...
        let claudeMD = """
            ...
            This project is managed by CodeForge.
    ...
    func updateClaudeMD(at path: String, project: Project, conventions: String = "") throws {
        let content = """
            ...
            ## Status
            Managed by CodeForge. Do not modify this file manually.
            """
