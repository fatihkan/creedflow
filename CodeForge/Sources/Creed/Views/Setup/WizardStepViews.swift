    ...
    var body: some View {
        Form {
            Section("Projects Directory") {
                ...
                Text("Where Creed creates project folders. Default: ~/Creed/projects/")
                    .font(.caption)
    ...
    var body: some View {
        Form {
            ...
            Section("Projects & Budget") {
                SummaryRow(label: "Projects directory", value: projectsBaseDir.isEmpty ? "~/Creed/projects/" : projectsBaseDir, ok: true)
